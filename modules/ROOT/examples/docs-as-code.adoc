...
[branch]`feature/jira-123`. Descriptive names can become confusing, vague, or
...
* main
feature/jira-123 feature/jira-456 feature/jira-789 release/v1.1.0 hotfix/v1.0.4
++++
...
* **Concept:** used when introducing or explaining an idea, like the overview
* of a complex feature.  **Task:** used when instructing user action, like
* enabling a feature within a product.  **Reference:** used when providing a
* large amount of scannable information, like tabular data about compatibility.
...
include::concept-x.adoc include::concept-y.adoc include::concept-z.adoc ++++
...
Check out xref::../tools/vale.adoc[my personal Vale configuration for this
portfolio, here.]
