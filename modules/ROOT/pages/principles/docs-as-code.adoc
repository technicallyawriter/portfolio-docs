...
Another valuable content reuse technique is topic typing. This approach categorizes content based on the purpose it serves as well as its style and theme. Generally, I prefer to organize content into three basic categories: *concept*, *task*, or *reference*.
...
Dedicating a page to a specific topic type is enough modularity sometimes. For increased reuse potential, I'll make each piece of content within a page more modular, if desired. For example:
