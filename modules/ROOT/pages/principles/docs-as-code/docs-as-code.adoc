...
include::pages$/principles/docs-as-code/git-feature-branching-workflow.adoc[]

include::pages$/principles/docs-as-code/git-feature-branch-naming-convention-rationale.adoc[]
...
// reviews rationale
include::pages$/principles/docs-as-code/reviews-rationale.adoc[]

// sme review rationale
include::pages$/principles/docs-as-code/sme-review-rationale.adoc[]

// peer review rationale
include::pages$/principles/docs-as-code/peer-review-rationale.adoc[]

// feature review rationale
include::pages$/principles/docs-as-code/feature-review-rationale.adoc[]
