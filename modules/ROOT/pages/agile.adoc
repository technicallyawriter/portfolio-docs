...
My preference between these approaches depends on the context. If I'm assigned to a specific dev team also running Scrum, I think Sprints for tech writing is effective. In this context, I can follow one sprint behind development and stay aligned with changes by attending their stand-up and planning meetings. If I'm stretched across several teams, I typically find Kanban most effective. Juggling simultaneous sprints can become overwhelming. If this is the case, I prefer to simplify the board and let release deadlines determine documentation priorities.
