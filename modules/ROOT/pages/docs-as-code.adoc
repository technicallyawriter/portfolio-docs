...
Validating documentation doesn't need to be purely subjective. Tools like link:https://vale.sh[Vale,_blank] deliver data around style guide adherence and readability. Vale lets you customize existing style guides and create your own rules to reflect your organization's preferences. It's a very powerful tool. 
