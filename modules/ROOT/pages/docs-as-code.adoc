...
.Bad example of acceptance criteria
[example]
...
xref:#_subject_matter_expert_sme_review[SME] and xref:#_peer_review[peer] reviews serve as the catch-all test for what escapes linters and acceptance criteria. This is the arena for "_I think this is confusing_" or "_I would word this differently_" type of feedback. We're humans after all, writing documentation for other humans, so it should pass these subjective criteria, too. Synthesizing murky (and sometimes conflicing) feedback into consistent and predictable documentation is yet another challenege for tech writers to take on.
