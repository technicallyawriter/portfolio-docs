...
* added "Agile methodology" to write-good xref:[exceptions list] so it won't flag it as "too wordy"
====
...
include::example$acceptance-crieria/bad-ac.adoc[]
include::example$acceptance-crieria/good-ac.adoc[]
