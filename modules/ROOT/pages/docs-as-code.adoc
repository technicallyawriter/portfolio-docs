...
Another valuable content reuse technique is topic typing. At it's most general, this can mean organizing content into three basic categories: **concept**, **task**, or **reference**. Each of these categories has their own template for displaying information consistently. This consistency makes content reuse easier, as the purpose of each section is narrowly scoped, so you can plug-and-play content as needed.
...
You can take topic typing further and make each piece of content a grandular type. For example:
...
This goes the way of DITA and is not my preference since you're often caught having to please the schema over what might otherwise be most helpful to the reader. I think structure is wonderful and should be enforced whenever possible, though I enjoy the flexibility of "breaking the rules" and displaying content in a different order, for example, if it helps make the docs more effective.
