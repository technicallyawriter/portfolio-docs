...
image::feature-branching-simple.png[Feature branches without release branch,150]
...
image::feature-branching-release.png[Feature branches with release branch,150]
...
image::feature-branching-release-hotfix.png[Feature branches with release and hotfix branch,150]
